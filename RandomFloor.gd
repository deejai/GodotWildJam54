...
var wall = load("res://Game/Objects/DungeonWall.tscn")
var wall_bot = load("res://Game/Objects/DungeonWall.tscn")
var wall_top = load("res://Game/Objects/DungeonWall.tscn")
var tile = load("res://Game/Objects/DungeonTile.tscn")
var tile_mossy = load("res://Game/Objects/DungeonTileMossy.tscn")
var rubble = load("res://Game/Objects/DungeonRubble.tscn")
...
func randomize_settings():
	room_size = randi_range(4, 4 + level / 2)
	...
	n_mobs = randi_range(8 + level / 2, 10 + 1 * level)
